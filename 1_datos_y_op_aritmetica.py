...
print('******************STR')
str_notmal  = 'Linea 1'
str_notmal  = 'Linea 1-s \tLinea 2-s \tLinea3-s \n'
...
num = 12.12    #float
isAuth = True  #bool
print(varibles, dato, num, 'str', isAuth, 12, 'Soy una cadena', False) # todos los paramtros pasado como arguemtnos a este metodo se imprimen en la terminal
...
print('*'*10, 'OP ARITMETICAS', '*'*10,) #********** OP ARITMETICAS **********
